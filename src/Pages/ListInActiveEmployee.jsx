...
function createData(employee_id,employee_name,employee_date_hired,employee_status,employee_branch,empolyee_section,employee_position) {
  return {employee_id,employee_name,employee_date_hired,employee_status,employee_branch,empolyee_section,employee_position};
}
...
export default function CustomizedTables() {
  ...
  useEffect(() => {
    ...
    fetch("http://ec2-13-37-245-245.eu-west-3.compute.amazonaws.com:4000/admin/employees/inactive-employees-list", requestOptions)
